...
export const globalStyles = css`
  :root {
    ...
    --sp-zIndices-top: 3;
    --sp-colors-surface1: #ffffff;
    --sp-colors-surface2: #efefef;
    --sp-colors-surface3: #f3f3f3;
    --sp-colors-disabled: #c5c5c5;
    --sp-colors-base: #323232;
    --sp-colors-clickable: #808080;
    --sp-colors-hover: #4d4d4d;
    --sp-colors-accent: #3973e0;
    --sp-colors-error: #ea3323;
    --sp-colors-errorSurface: #fcf1f0;
    --sp-colors-warning: #6a4516;
    --sp-colors-warningSurface: #fef2c0;
    ...
    --sp-syntax-color-plain: #151515;
    --sp-syntax-color-comment: #999;
    --sp-syntax-fontStyle-comment: italic;
    --sp-syntax-color-keyword: #7c5ae3;
    --sp-syntax-color-tag: #0971f1;
    --sp-syntax-color-punctuation: #3b3b3b;
    --sp-syntax-color-definition: #85a600;
    --sp-syntax-color-property: #3b3b3b;
    --sp-syntax-color-static: #3b3b3b;
    --sp-syntax-color-string: #2e6bd0;
  ...
  :root {
    ...
    --table-cell-padding: var(--table-cell-vertical-padding)
      var(--table-cell-horizontal-padding);
    --table-input-cell-padding: calc(
        var(--table-cell-vertical-padding) * 2 + 2px
      )
      var(--table-cell-horizontal-padding);
    ...
    --table-mixed-content-vertical-gap: 8px;
    --table-mixed-content-horizontal-gap: 10px;
    --btn-font-size: 15px;
